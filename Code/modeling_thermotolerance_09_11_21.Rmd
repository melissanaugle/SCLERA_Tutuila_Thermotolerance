...
setwd(dir = "C:/Users/Thomas.Oliver/WORK/Projects/SCLERA/2021_Final_Data/Final Data Push GD/")
rm( list = ls())
#graphics.off()
library(reshape2)
library(DescTools)
...
```{r}
site2014=read.csv("C:/Users/Thomas.Oliver/WORK/Projects/SCLERA/2021_Final_Data/2014/raw/ThermalResistance_SpeciesBySite.csv")
...
LD50_2014 <- read.csv("2014_ColonyOutput_Assays_SCLERA.csv")
...
LD50_2019 <- read.csv("2019_UniqueColony_SCLERAModeling_v1.5.csv")
...
symbiont_2014 <- read.csv("2014_fromtom_symbiont_log_ratios_allsites_08_05_21_LBSP.csv")
symbiont_2014$Site <- NULL
symbiont_2014$Season <- NULL
symbiont_2019 <- read.csv("2019_symbiont_log_ratios_08_05_21_LBSP.csv")
symbiont_2019$Site_Col <- paste0(symbiont_2019$Site,"_",symbiont_2019$Colony)

GE_controls_2019 <- read.csv("eignegenes_controls.csv")
